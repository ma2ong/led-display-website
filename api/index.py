...
def admin_page_editor(page_name):
    ...
    page_info = {
        'home': {'title': '首页管理', 'description': '管理网站首页内容'},
        'about': {'title': '关于我们管理', 'description': '管理关于我们页面内容'},
        'products': {'title': '产品中心管理', 'description': '管理产品展示页面'},
        'solutions': {'title': '解决方案管理', 'description': '管理解决方案页面'},
        'cases': {'title': '成功案例管理', 'description': '管理成功案例页面'},
        'news': {'title': '新闻资讯管理', 'description': '管理新闻资讯页面'},
        'support': {'title': '技术支持管理', 'description': '管理技术支持页面'},
        'contact': {'title': '联系我们管理', 'description': '管理联系我们页面'}
    }
    
    page = page_info.get(page_name, {'title': '页面管理', 'description': '管理页面内容'})
    return render_template('content_editor.html', page_name=page_name, page=page)
