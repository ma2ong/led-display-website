...
-- 注意：存储桶需要在 Supabase Dashboard 中创建
...
/*
完成以上步骤后，您的 Supabase Storage 已配置完成！

下一步：
1. 在 Supabase Dashboard 手动创建 'led-images' 存储桶
2. 使用网页版图片管理后台上传图片
3. 图片会自动保存到 Supabase Storage
4. 可以在任何页面通过 URL 访问图片
...
图片 URL 格式：
https://[PROJECT_ID].supabase.co/storage/v1/object/public/led-images/[PATH]

例如：
https://jirudzbqcxviytcmxegf.supabase.co/storage/v1/object/public/led-images/products/outdoor-led-main.jpg
*/
